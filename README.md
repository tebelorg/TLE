...
The first and base script coded is to transform spreadsheet data (or MySQL database) by remapping columns and preparing data for import by downstream system. Specific use case is syncing ipcLink system used by Singapore non-profits to MYOB accounting.
